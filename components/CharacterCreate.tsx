...
const CharacterCreate: React.FC<CharacterCreateProps> = ({ onBegin }) => {
  ...
  return (
    <div className="min-h-screen w-screen overflow-y-auto bg-[#eae7dc] text-stone-900">
      <div className="max-w-5xl mx-auto px-4 py-10 md:py-16">
        <p className="font-typewriter text-xs tracking-[0.35em] uppercase text-stone-500 mb-3">
          Run zero · 西蒙-克吕贝里埃街 11 号
        </p>
        <h1 className="font-serif text-4xl md:text-6xl font-bold mb-3">你是谁，在二十点整走进楼里？</h1>
        <p className="font-serif text-lg text-stone-600 max-w-2xl leading-relaxed mb-10">
        ...
        <div className="bg-[#f4f1ea] border border-stone-300 p-6 mb-8">
        ...
        <button
          ...
          className="px-8 py-4 bg-stone-800 text-[#f4f1ea] font-typewriter uppercase tracking-[0.2em] text-sm disabled:opacity-40 hover:bg-stone-700"
        >
          进入冻结的二十点
        </button>
      </div>
